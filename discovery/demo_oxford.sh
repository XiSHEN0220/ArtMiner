python oxford_retrieval.py --scaleImgRef 25 --houghInitial --cuda --featScaleBase 20 --finetunePath ../model/resnet18.pth --valOrTest test --outResJson Oxford_resnet.json --scaleImgRef 25
